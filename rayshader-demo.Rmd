...
# BUILD: rmarkdown::render('rayshader-demo.Rmd', output_file = 'docs/index.html')
...
knitr::include_graphics(file.path("images", "monetereybay-3D.png"))
```
...
```
```{r echo=FALSE}
knitr::include_graphics(file.path("images", "sf-3d-overlay.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(file.path("images", "montereybay.gif"))
```
